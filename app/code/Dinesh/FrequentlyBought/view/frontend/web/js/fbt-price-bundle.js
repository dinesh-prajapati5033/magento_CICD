define([
    ...
    $.widget('dinesh.frequently_bought_bundle_option', $.mage.priceBundle, {
    ...
    return $.dinesh.frequently_bought_bundle_option;
    ...
    function defaultGetOptionValue(element, config) {
        var changes = {},
            ...
            productId = element.closest('li').find('.related-checkbox').attr('data-dinesh-fbt-product-id'),
