...
namespace Mageants\FrequentlyBought\Block\Adminhtml\Catalog\Product\Edit\Tab;
...
class Customtype extends Extended
{
     ...
     * @return string
     */
    public function getNumberToWord($num = '')
    {
        $num = ( string ) ( ( int ) $num );
    ...
    /**
     * Return frequently bought together URL
     *
     * @return string
     */
    public function getFormAction()
    {
        return $this->getBaseUrl() . 'frequentlybought/add/all';
    }

    /**
     * Get and return product details
     *
