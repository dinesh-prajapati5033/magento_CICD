...
namespace Mageants\FrequentlyBought\Model\CatalogImportExport\Import;

use Magento\CatalogImportExport\Model\Import\Product as Products;
use Magento\Catalog\Model\Product\Link;
use Mageants\FrequentlyBought\Model\Catalog\Product\Link as Links;
...
class Product extends Products
{
    ...
    protected $_linkNameToId = [
        ...
        '_customtype_' => Links::LINK_TYPE_FREQUENTLYBOUGHTTOGETHER
    ];
    ...
    protected $_fieldsMap = [
        ...
        Products::COL_STORE => 'store_view_code',
        Products::COL_ATTR_SET => 'attribute_set_code',
        Products::COL_TYPE => 'product_type',
        Products::COL_PRODUCT_WEBSITES => 'product_websites',
