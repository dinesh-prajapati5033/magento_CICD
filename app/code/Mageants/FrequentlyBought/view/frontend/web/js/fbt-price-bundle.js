define([
    ...
    $.widget('mageants.frequently_bought_bundle_option', $.mage.priceBundle, {
    ...
    return $.mageants.frequently_bought_bundle_option;
    ...
    function defaultGetOptionValue(element, config) {
        var changes = {},
            ...
            productId = element.closest('li').find('.related-checkbox').attr('data-mageants-fbt-product-id'),
