...
namespace Mageants\HyvaFrequentlyBought\Block\Product\View\Type;
...
class Configurable extends \Mageants\FrequentlyBought\Block\Product\View\Type\Configurable
{
    protected const FBT_RENDERER_TEMPLATE =
     'Mageants_HyvaFrequentlyBought::product/view/type/configurable/renderer.phtml';
