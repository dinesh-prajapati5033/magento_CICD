...
class SetBlockPosition extends \Mageants\FrequentlyBought\Observer\SetBlockPosition
{
    /**
     ...
     *
     * @param \Mageants\FrequentlyBought\Helper\Data $helper
     * @param DesignInterface $theme
     */
    public function __construct(
        \Mageants\FrequentlyBought\Helper\Data $helper,
            ...
            if ($fullActionName=='catalog_product_view' || $fullActionName=='checkout_cart_configure') {
                ...
                if ($getPosition[0] !='') {
                    if ($getPosition[0]=='content' && $getPosition[1]=='before') {
                        $myXml = '<move element="mageants.frequently.bought.together.new"
